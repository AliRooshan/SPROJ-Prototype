            ...
            <header className="border-b border-indigo-100 sticky top-0 bg-white/90 backdrop-blur-md z-50 shadow-sm relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-4">
                        <Link to="/explore" className="px-5 py-2.5 text-sm font-bold text-white bg-indigo-600 border border-indigo-600 rounded-xl hover:bg-indigo-700 hover:border-indigo-700 hover:shadow-md hover:-translate-y-0.5 transition-all shadow-sm">Explore Programs</Link>
                        <Link to="/login" className="px-5 py-2.5 text-sm font-bold text-white bg-indigo-600 border border-indigo-600 rounded-xl hover:bg-indigo-700 hover:border-indigo-700 hover:shadow-md hover:-translate-y-0.5 transition-all shadow-sm">Sign In</Link>
                        <Link to="/login" state={{ isSignUp: true }} className="px-5 py-2.5 text-sm font-bold text-white bg-indigo-600 border border-indigo-600 rounded-xl hover:bg-indigo-700 hover:border-indigo-700 hover:shadow-md hover:-translate-y-0.5 transition-all shadow-sm">Sign Up</Link>
                    </nav>
